...
def get_gt():
    ...
    return ground_truth_files_list, gt_counter_per_class, counter_images_per_class, gt_classes, n_classes

"""
 detection-results
     Load each of the detection-results files into a temporary ".json" file.
"""
def detection_results(op,results, gt_classes):
